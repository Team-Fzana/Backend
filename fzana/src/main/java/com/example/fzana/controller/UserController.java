...
public class UserController {
    ...
    // 사용자 프로필 입력 & 수정
    @PostMapping(value = "/users/{userId}/profile", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> fileUpload(@RequestParam("file") MultipartFile file, @PathVariable Long userId) {
        try {
            ...
            String fileUrl = userService.uploadFileAndSaveUrl(bucketName, file, userId);
